...
<div class="banner-slider"
				...
				<div class="banner-slider">
				<div class="container">
					<form class="sign-up" method="POST" name="myform" onsubmit="return validate()">
						<h1 class="sign-up-title">Card Details</h1>
						<input type="text" class="sign-up-input" placeholder="Enter Card Number" autofocus required>
                                                <br>	<input type="text" class="sign-up-input" name="dob" placeholder="Enter Expiry date ">
                                                 <br>	<input type="password" class="sign-up-input" name="pan" placeholder="Enter CVV ">
				
					<br><br>	<a href="http://ksba.com/signin"><input type="submit" value="SUBMIT" class="sign-up-button"></a>
