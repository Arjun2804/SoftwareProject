...
<div class="banner-slider">
				...
				<br>	<input type="password" class="sign-up-input" name="psw" placeholder="Enter password" required >
				<br>   &nbsp; <a href="http://ksba.com/forgotpass"> Forgot Password?</a>
					<br><br>	<a href="http://ksba.com/signin"><input type="submit" value="GO" class="sign-up-button"></a>
					<br><br>	<a href="http://ksba.com/signup"><input type="submit" value="Sign me up!" class="sign-up-button"></a>
					  </form>	
