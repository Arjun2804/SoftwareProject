...
<div class="banner-slider"
				...
				<div class="container">
					<form class="sign-up" method="POST" name="myform" onsubmit="return validate()">
						<h1 class="sign-up-title">Error!</h1>
						
					<br><br>	<a href="http://ksba.com/signin"><input value="Retry" class="sign-up-button"></a>
                                        <p><a href="http://ksba.com/"> Forgot UserID?</a></p>
                                        <p><a href="http://ksba.com/"> Forgot Password?</a></p>
