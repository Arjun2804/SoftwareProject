...
<div class="banner-slider"
				...
				<div class="container">
					<form class="sign-up" method="POST" name="myform" onsubmit="return validate()">
						...
						<h1 class="sign-up-title">Password Reset has been Successfully Done.</h1>
                                                
				
					<br><br>	<a href="http://ksba.com/signin"><input type="submit" value="LOGIN" class="sign-up-button"></a>
