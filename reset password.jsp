...
<div class="banner-slider"
				...
				<div class="container">
					<form class="sign-up" method="POST" name="myform" onsubmit="return validate()">
						...
						<input type="password" class="sign-up-input" placeholder="Enter New Password" autofocus required>
                                                <br>	<input type="password" class="sign-up-input" name="dob" placeholder="Re-Enter Password ">
